...
Future<void> main() async {
  ...
  if(GetPlatform.isWeb){
    await Firebase.initializeApp(options: const FirebaseOptions(
        apiKey: "AIzaSyBph0kiSBE2U2E8BOHLtvgOT9ma2AY-kGw",
        authDomain: "lovasy-all.firebaseapp.com",
        projectId: "lovasy-all",
        storageBucket: "lovasy-all.firebasestorage.app",
        messagingSenderId: "341916879476",
        appId: "1:341916879476:web:fb3a23a8f919997aaa9f21"
    ));
  } else if(GetPlatform.isAndroid) {
    await Firebase.initializeApp(
      options: const FirebaseOptions(
        apiKey: "AIzaSyAOYs2sXGQ6PjAOHdH8uAjoFZ1S9yW-o38",
        appId: "1:341916879476:android:5a4d3a070d104baaaa9f21",
        messagingSenderId: "341916879476",
        projectId: "lovasy-all",
      ),
    );
