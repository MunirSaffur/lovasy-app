                                ...
                                child: Stack(children: [
                                  ...
                                  Center(
                                    ...
                                    child: Container(
                                      width: 65, height: 65,
                                      decoration: BoxDecoration(
                                        // لون الحدود هو نفس لون خلفية الـ Bottom Bar ليعطي إيحاء "القطع"
                                        border: Border.all(color: Theme.of(context).cardColor, width: 6),
                                        shape: BoxShape.circle,
                                        boxShadow: [
                                          BoxShadow(
                                              color: Theme.of(context).primaryColor.withValues(alpha: 0.3),
                                              blurRadius: 10, spreadRadius: 1, offset: const Offset(0, 4)
                                          )
                                        ],
                                      ),
                                      child: FloatingActionButton(
                                        ...
                                        child: isTaxiWithCache
                                            ? TaxiCartWidget(color: Colors.white, size: 24)
                                            : isParcel
                                            ? const Icon(CupertinoIcons.add, size: 30, color: Colors.white)
                                            : CartWidget(color: Colors.white, size: 24),
                                      ),
                                    ),
                                  ),
