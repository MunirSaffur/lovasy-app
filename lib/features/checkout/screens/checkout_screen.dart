      ...
      body: guestCheckoutPermission || AuthHelper.isLoggedIn() ? GetBuilder<CheckoutController>(builder: (checkoutController) {
        ...
        return GetBuilder<CouponController>(builder: (couponController) {
          ...
          Future.delayed(const Duration(milliseconds: 50), () {
            ...
            if(((widget.storeId == null && checkoutController.store != null) || widget.storeId != null) && (checkoutController.isFirstTime || (couponController.discount! > 0 && !checkoutController.isFirstTime && !_calledOrderTax))){
          ...
          Future.delayed(const Duration(milliseconds: 800), () {
            if(_payableAmount != checkoutController.viewTotalPrice && checkoutController.distance != null && checkoutController.distance != -1.0 && isLoggedIn) {
