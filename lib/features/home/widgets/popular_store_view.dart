                                            ...
                                            Positioned(
                                              ...
                                              child: GetBuilder<FavouriteController>(
                                                builder: (favouriteController) {
                                                  ...
                                                  return LikeButton(
                                                    size: 20,
                                                    // نضمن أن الحالة مرتبطة بالمفضلة الفعلية وبحالة تسجيل الدخول
                                                    isLiked:
                                                    ...
                                                    likeBuilder: (bool isLiked) {
                                                      // نتحقق من حالتين: هل هو مسجل وهل هو في المفضلة فعلاً؟
                                                      bool isActive =
                                                          AuthHelper.isLoggedIn() &&
                                                          isWished;
                                                      return Icon(
                                                    ...
                                                    onTap: (isLiked) async {
                                                      if (AuthHelper.isLoggedIn()) {
                                                        // إذا كان مسجلاً، نقوم بعملية الإضافة/الحذف ونعيد الحالة الجديدة للعنصر
                                                        if (isWished) {
                                                           favouriteController
                                                        ...
                                                        // نعيد عكس الحالة الحالية لأن العملية تمت بنجاح
                                                        return !isLiked;
                                                      } else {
                                                        // إذا لم يكن مسجلاً، نظهر الرسالة ونعيد الحالة "غير مضغوط" (false)
                                                        showCustomSnackBar(
                                                          'you_are_not_logged_in'
                                                              .tr,
                                                        );
                                                        return false; // هذا السطر يضمن بقاء القلب favorite_border
                                                      }
                                                    },
                                                  );
                                                },
